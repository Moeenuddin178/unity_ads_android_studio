package com.mod.poppyPlaytime.card5;
...
public class card5_1 extends AppCompatActivity{
    AlertDialog.Builder builder;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_card51);
        ...
        btnDownload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Uri uri = Uri.parse("https://sfdmobile.com/poppy-playtime-on-planetminecraft-com.png");

package com.mod.poppyPlaytime.card6;
...
public class card62 extends AppCompatActivity {
    AlertDialog.Builder builder;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_card62);
        backHome();
        ...
        btnDownload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               /* DownloadManager downloadmanager = (DownloadManager) getSystemService(Context.DOWNLOAD_SERVICE);
                Uri uri = Uri.parse("https://sfdmobile.com/Poppy%20Playtime%20Addon.mcaddon");
                ...
                DownloadManager downloadmanager = (DownloadManager) getSystemService(Context.DOWNLOAD_SERVICE);
                Uri uri = Uri.parse("https://sfdmobile.com/Poppys%20Playtime%20map.mcworld");
